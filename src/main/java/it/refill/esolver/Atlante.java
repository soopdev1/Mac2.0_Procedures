...
import static it.refill.esolver.Util.getDateRif;
            ...
            try {
                if (base64_2A != null) {
                    if (checkTXT(base64_2A)) {
                        ...
                        FileUtils.copyFile(base64_2A, out2);
                        if (checkTXT(out2)) {
                            atl_ok.add(out2);
                ...
                if (base64_4A != null) {
                    if (checkTXT(base64_4A)) {
                        ...
                        FileUtils.copyFile(base64_4A, out4);
                        if (checkTXT(base64_4A)) {
                            atl_ok.add(out4);
                ...
                if (base64_6A != null) {
                    if (checkTXT(base64_6A)) {
                        ...
                        FileUtils.copyFile(base64_6A, out6);
                        if (checkTXT(out6)) {
                            atl_ok.add(out6);
                ...
                if (base64_7A != null) {
                    if (checkTXT(base64_7A)) {
                        ...
                        FileUtils.copyFile(base64_7A, out7);
                        if (checkTXT(out7)) {
                            atl_ok.add(out7);
