...
import static it.refill.gs.Config.apptype;
import static it.refill.gs.Config.link_PROD;
import static it.refill.gs.Config.log;
import static it.refill.gs.Config.passwordWS;
import static it.refill.gs.Config.usernameWS;
...
//            printJSONObject(obj);
    ...
    public static List<Filiale> getInputList() {
        List<Filiale> input = new ArrayList<>();

//        String[] filiale1 = {"178", "3000000000236"};
//        String[] filiale1 = {"043", "3000000000236"};
//        String[] filiale2 = {"042", "1000000001415"};
//        ing.add(filiale1);
//        ing.add(filiale2);
//        ing.add(filiale3);
