 ...
 */
package it.refill.spreadexcel;

import static it.refill.spreadexcel.Utility.createLog;
import static it.refill.spreadexcel.Utility.pattern4;
import static it.refill.spreadexcel.Utility.rb;
 ...
 * @author rcosco
 */
public class MacSpreadExcel {

    private static final Logger log = createLog("Mac2.0_EXCELSPREAD_", rb.getString("path.log"), pattern4);

    private static final String host = "//machaproxy01.mactwo.loc:3306/" + rb.getString("db.name");

    private static void excelspread(String host) {
