...
import static it.refill.testarea.Mactest.host_TEST;
...
public class Maintenance {
    ...
    private static void CENTRAL_deleteaggiornamentimenouno(String datalike) {
    ...
    private static void CENTRAL_delete_chtransactiondoc_story() {
        System.out.println("DELETE AGGIORNAMENTI DOC STORY, START...");
        Db db = new Db(host_PROD, false);
        try {
            if (db.getC() != null) {
...
//            CENTRAL_deleteaggiornamentimenouno("20012");
//        }
//
