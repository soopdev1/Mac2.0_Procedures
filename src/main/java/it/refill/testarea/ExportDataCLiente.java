...
//        cell10.setCellStyle(style1);
        ...
        try {
            ...
            String se_ip = "172.18.17.34";
            int se_port = 22;
            ChannelSftp sftpseta = connect(se_user, se_pwd, se_ip, se_port);
...
//                String rate = rs.getString(11);
            ...
            System.out.println("mactest.ExportDataCLiente.main() " + sftpseta.isConnected());
            closeConnection(sftpseta);
