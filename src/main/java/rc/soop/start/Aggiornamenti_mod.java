...
public class Aggiornamenti_mod {
    ...
    public Aggiornamenti_mod(String cod, String filiale, String dt_start, String fg_stato, String tipost, String action, String user) {
        this.cod = cod;
        this.filiale = filiale;
        this.dt_start = dt_start;
        this.fg_stato = fg_stato;
    ...
    public Aggiornamenti_mod(String cod,String dt_start,String tipost,String action){
        this.cod = cod;
        this.dt_start = dt_start;
        this.tipost = tipost;
        this.action = action;
