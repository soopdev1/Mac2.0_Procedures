...
import static rc.soop.esolver.Util.calcolaIva;
import static rc.soop.esolver.Util.checkTXT;
import static rc.soop.esolver.Util.copyFile_R;
import static rc.soop.esolver.Util.createFile_R;
...
import static rc.soop.esolver.Util.formatDoubleforMysql;
import static rc.soop.esolver.Util.getCity_apm;
import static rc.soop.esolver.Util.getNC_category;
import static rc.soop.esolver.Util.getNC_causal;
import static rc.soop.esolver.Util.getValueDiff;
import static rc.soop.esolver.Util.get_ET_change_value;
import static rc.soop.esolver.Util.get_customerKind;
import static rc.soop.esolver.Util.get_user;
import static rc.soop.esolver.Util.get_vat;
import static rc.soop.esolver.Util.list_oc_errors;
...
import static rc.soop.esolver.Util.query_transaction_ch;
import static rc.soop.esolver.Util.query_transaction_value;
import static rc.soop.esolver.Util.rb;
import static rc.soop.esolver.Util.removeDuplicatesAL;
import static rc.soop.esolver.Util.removeDuplicatesALAr;
            ...
            try {
                ...
                if (base64_1 != null) {
                    if (checkTXT(base64_1)) {
                        try {
//                            String path1 = pathout + base64_1.getName();
//                            File out1 = createFile_R(path1);
//                            copyFile_R(base64_1, out1);
//                            if (checkTXT(out1)) {
//                                log.log(Level.INFO, "{0} RILASCIATO.", out1.getName());
//                            }
                            if (rilasciaFileEsolver(base64_1)) {
                                log.log(Level.INFO, "{0} RILASCIATO.", base64_1.getName());
                            }
                        } catch (Exception e) {
                ...
                if (base64_2 != null) {
                    if (checkTXT(base64_2)) {
                        try {
//                            String path2 = pathout + base64_2.getName();
//                            File out2 = createFile_R(path2);
//                            copyFile_R(base64_2, out2);
//                            if (checkTXT(out2)) {
//                                log.log(Level.INFO, "{0} RILASCIATO.", out2.getName());
//                            }
                            if (rilasciaFileEsolver(base64_2)) {
                                log.log(Level.INFO, "{0} RILASCIATO.", base64_2.getName());
                            }
                        } catch (Exception e) {
                            log.severe(estraiEccezione(e));
                        }
                ...
                if (base64_3 != null) {
                    if (checkTXT(base64_3)) {
                        try {
//                            String path3 = pathout + base64_3.getName();
//                            File out3 = createFile_R(path3);
//                            copyFile_R(base64_3, out3);
//                            if (checkTXT(out3)) {
//                                log.log(Level.INFO, "{0} RILASCIATO.", out3.getName());
//                            }
                            if (rilasciaFileEsolver(base64_3)) {
                                log.log(Level.INFO, "{0} RILASCIATO.", base64_3.getName());
                            }
                        } catch (Exception e) {
                            log.severe(estraiEccezione(e));
                        }
                ...
                if (base64_4 != null) {
                    if (checkTXT(base64_4)) {
                        try {
//                            String path4 = pathout + base64_4.getName();
//                            File out4 = createFile_R(path4);
//                            copyFile_R(base64_4, out4);
//                            if (checkTXT(out4)) {
//                                log.log(Level.INFO, "{0} RILASCIATO.", out4.getName());
//                            }
                            if (rilasciaFileEsolver(base64_4)) {
                                log.log(Level.INFO, "{0} RILASCIATO.", base64_4.getName());
                            }
                        } catch (Exception e) {
                            log.severe(estraiEccezione(e));
                        }
                ...
                if (base64_5 != null) {
                    if (checkTXT(base64_5)) {
                        try {
//                            String path5 = pathout + base64_5.getName();
//                            File out5 = createFile_R(path5);
//                            copyFile_R(base64_5, out5);
//                            if (checkTXT(out5)) {
//                                log.log(Level.INFO, "{0} RILASCIATO.", out5.getName());
//                            }
                            if (rilasciaFileEsolver(base64_5)) {
                                log.log(Level.INFO, "{0} RILASCIATO.", base64_5.getName());
                            }
                        } catch (Exception e) {
                            log.severe(estraiEccezione(e));
                        }
