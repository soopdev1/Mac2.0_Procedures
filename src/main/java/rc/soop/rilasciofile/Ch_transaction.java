...
public class Ch_transaction {
    ...
    public static String formatSTATUS_BBSB(String bb_sb) {
        if (bb_sb == null) {
            return "NO";
        } else if (bb_sb.equals("Y")) {
            return "YES";
        } else if (bb_sb.equals("F")) {
            return "FREE";
        }
        return "NO";
    }
    ...
    public static String format_BB_SB(Ch_transaction res) {
        if (!res.getBb().equals("0")) {
            if (res.getTipotr().equals("B")) {
                ...
                } else if (res.getBb().equals("3")) {
                    return "<span class='font-red ital'>&nbsp;&nbsp;<b>SB</b></span>";
                } else if (res.getBb().equals("4")) {
    ...
    public static String formatTilltr(String del, String bb_testata, String fatnum, String supporto, String bb_riga, boolean modify) {
        String start;
